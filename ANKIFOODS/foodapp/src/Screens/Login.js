...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch(`${myurl}/api/auth/login`, {
      // credentials: 'include',
  ...
  return (
    ...
    <div style={{backgroundImage: 'url("https://images.pexels.com/photos/326278/pexels-photo-326278.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', height: '100vh', backgroundSize: 'cover', padding:"60px" }}>
