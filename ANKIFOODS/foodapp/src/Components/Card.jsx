...
export default function Card(props) {
  // var data = useCart();
  var myCart = JSON.parse(localStorage.getItem("foodCart")) || [];
  ...
  const handleAddToCart = async () => {
    ...
    if (food !== []) {
      if (food.size === size) {
        ...
        alert("update to cart");
        return
      }
      else if (food.size !== size) {
        myCart.push({id: foodItem._id, name: foodItem.name, price: finalPrice, qty: qty, size: size,img: props.ImgSrc});
