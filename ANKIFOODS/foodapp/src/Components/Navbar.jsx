...
export default function Navbar(props) {
    // const [cartLength, setCartLength] = useState(addedCart.length || 0);
    ...
    // const [count, setCount] = useState(JSON.parse(localStorage.getItem("foodCart")).length || 0);
        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">AnkiFood</Link>
